      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-5 text-center sm:px-6 md:grid-cols-3 md:text-left">
        ...
        <div>
          ...
          <div className="flex flex-wrap justify-center gap-2 text-2xl md:justify-start">
            <a href="https://github.com/ethioCodingRoom" target="_blank" rel="noreferrer" aria-label="GitHub" className="rounded-lg p-2"><FaGithub className="transition-colors hover:text-gray-400" /></a>
            <a href="https://www.hackerrank.com/ethioCodingRoom" target="_blank" rel="noreferrer" aria-label="HackerRank" className="rounded-lg p-2"><SiHackerrank className="transition-colors hover:text-green-500" /></a>
            <a href="https://www.coursera.org/user/ethioCodingRoom" target="_blank" rel="noreferrer" aria-label="Coursera" className="rounded-lg p-2"><SiCoursera className="transition-colors hover:text-blue-500" /></a>
            <a href="https://www.datacamp.com/portfolio/asresgamu" target="_blank" rel="noreferrer" aria-label="DataCamp" className="rounded-lg p-2"><SiDatacamp className="transition-colors hover:text-yellow-500" /></a>
            <a href="https://www.kaggle.com/ethioCodingRoom" target="_blank" rel="noreferrer" aria-label="Kaggle" className="rounded-lg p-2"><SiKaggle className="transition-colors hover:text-blue-400" /></a>
            <a href="https://public.tableau.com/app/profile/asres.yelia/vizzes" target="_blank" rel="noreferrer" aria-label="Tableau Public" className="rounded-lg p-2"><IoLogoTableau className="transition-colors hover:text-sky-400" /></a>
            <a href="https://www.geeksforgeeks.org/profile/asresgamu/" target="_blank" rel="noreferrer" aria-label="GeeksforGeeks" className="rounded-lg p-2"><SiGeeksforgeeks className="text-gray-400 transition-colors hover:text-green-500" /></a>
            <a href="https://www.credly.com/users/ethiocodingroom" target="_blank" rel="noreferrer" aria-label="Credly" className="rounded-lg p-2"><SiCredly className="transition-colors hover:text-orange-400" /></a>
          </div>
        </div>
