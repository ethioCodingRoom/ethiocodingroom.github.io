      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-5 text-center sm:px-6 md:grid-cols-3 md:text-left">
        ...
        <div>
          ...
          <div className="flex flex-wrap justify-center gap-2 text-2xl md:justify-start">
            ...
            <a href="https://public.tableau.com/app/profile/asres.yelia/vizzes" target="_blank" rel="noreferrer" aria-label="Tableau Public" className="rounded-lg p-2"><FaChartBar className="transition-colors hover:text-sky-400" /></a>
